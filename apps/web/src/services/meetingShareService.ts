...
const DEFAULT_SHARE_TTL_OPTIONS_MINUTES = [60, 1440, 10080];
...
function getConfiguredTtlOptionsMinutes(): number[] {
...
function resolveExpiresAt(ttlMinutes?: number, noExpiry?: boolean): Date | null {
